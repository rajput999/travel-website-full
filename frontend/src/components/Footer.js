  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.subtitle}>Travel and Condition</div>
        <div className={styles.subtitle}>Privacy</div>
      </div>

      <div className={styles.container}>
        <div className={styles.title}>Contact</div>
        <div className={styles.subtitle}>6395848115</div>
        <div className={styles.subtitle}>rajput9997647419@gmail.com</div>
      </div>
    </footer>
  );
};
